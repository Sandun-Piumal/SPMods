...
async function saveChatSessionsToDatabase() {
    try {
        ...
        await database.ref('userChatSessions/' + user.uid).set(sessionsData);
...
async function handleLogin(event) {
    ...
    try {
        ...
        await updateUserLoginTime(userCredential.user);
...
async function handleSignup(event) {
    ...
    try {
        ...
        const saveSuccess = await saveUserToDatabase(userCredential.user, name);
