...
const firebaseConfig = {
  ...
  databaseURL: "https://smart-ai-chat-app-default-rtdb.firebaseio.com" // Added database URL
};
...
// AUTH HANDLERS - FIXED WITH DATABASE SAVE
async function handleLogin(event) {
  ...
  try {  
    ...
    await db.ref('users/' + user.uid + '/lastLogin').set(
...
async function handleSignup(event) {
  ...
  try {  
    ...
    // Save user data to Firebase Database - FIXED
    const user = userCredential.user;
